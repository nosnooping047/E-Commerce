...
urlpatterns = [
    ...
    path('ProdutosApp/', include('ProdutosApp.urls')),
    path('UsuariosCadastroApp/', include('UsuariosCadastroApp.urls')),
    path('HomeApp/', include('HomeApp.urls')),
    path('SobreApp/', include('SobreApp.urls')),
    path('MonteSeuComputadorApp/', include('MonteSeuComputadorApp.urls')),
